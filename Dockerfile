...
CMD php artisan migrate --force || true; php artisan db:seed --class="Database\\Seeders\\ProductSeeder" --force || true; php artisan db:seed --class="Database\\Seeders\\StorefrontPromoSeeder" --force || true; apache2-foreground
